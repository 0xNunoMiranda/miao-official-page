-- ============================================================
-- STORED PROCEDURES - VERSÃO PARA EXECUÇÃO INDIVIDUAL
-- ============================================================
-- Use este arquivo se o DELIMITER $$ não funcionar no seu cliente SQL
-- Execute cada stored procedure individualmente através da interface
-- do seu cliente SQL (phpMyAdmin, MySQL Workbench, etc.)
-- ============================================================
