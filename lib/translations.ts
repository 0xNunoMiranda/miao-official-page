...
export const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "swap.title": "Swap",
    "swap.chart": "Chart",
    "swap.youPay": "Voce paga",
    "swap.youReceive": "Voce recebe",
    "swap.balance": "Saldo",
    "swap.max": "Max",
    ...
    "swap.swap": "Swap",
    "swap.success": "Swap Concluido!",
    "swap.received": "Recebeu",
    "swap.viewSolscan": "Ver no Solscan",
    "swap.close": "Fechar",
    "swap.connectWalletMessage": "Conecte sua carteira para fazer swap",
    "swap.insufficientBalance": "Saldo insuficiente.",
    "swap.quoteError": "Nao foi possivel obter cotacao.",
    "swap.error": "Erro ao obter cotacao.",
    "swap.executeError": "Erro ao executar swap.",
    "swap.poweredBy": "Powered by Jupiter Aggregator",
    "swap.searchToken": "Pesquisar nome ou endereco...",
    "swap.searching": "A procurar token...",
    "swap.loading": "A carregar...",
    "swap.tokenNotFound": "Token nao encontrado",
    "swap.noTokensFound": "Nenhum token encontrado",
    "swap.addToken": "Cole um endereco de contrato para adicionar qualquer token",
