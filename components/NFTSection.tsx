...
const NFT_ATTRIBUTES = [
  {
    trait: "Background",
    values: ["Mystic Purple", "Shadow Black", "Neon Green", "Cyber Blue"],
  },
...
const NFTSection: React.FC<NFTSectionProps> = ({
    ...
    return selectedIds.map((id, index) => {
      ...
      return {
        ...
        attribute: showAttribute
          ? { trait: randomAttr.trait, value: randomValue }
          : undefined,
  ...
  return (
    ...
    >
      ...
      {/* Background video: grayscale, slightly lower opacity, slower playback */}
      <div
      ...
      >
        <video
          ...
          src="/assets/page/nft-video.webm"
          ref={(el) => {
            if (el) {
              try {
        ...
        >
          <div
            ...
            style={{
              ...
              backgroundImage:
                "repeating-linear-gradient(135deg, rgba(255,255,255,0.03) 0px, rgba(255,255,255,0.03) 1px, transparent 2px, transparent 12px)",
            }}
          >
            {isChristmasMode && (
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(${
                    45 + bgAnimation * 25
                  }deg, var(--bg-tertiary), var(--bg-primary), var(--bg-tertiary))`,
                      ...
                      style={{
                        ...
                        animation: isVisible
                          ? getEntranceAnimation(
                              nft.entranceAnimation,
                              nft.delay
                            )
                          : getExitAnimation(
                              currentExitAnim || nft.exitAnimation,
                              nft.delay
                            ),
                      }}
                    >
                      <div
                        style={{
                          animation: isVisible
                            ? getContinuousAnimationStyle(
                                nft.continuousAnimation,
                                nft.animationDuration
                              )
                            : "none",
