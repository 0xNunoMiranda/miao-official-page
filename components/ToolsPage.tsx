...
import { ArrowLeft, Lock, Palette, CheckSquare, Trophy, Zap, Download, RefreshCw, Star, Share2, Crown, Gem, Users, Twitter, Send, Share } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen pt-32 pb-12 flex flex-col items-center justify-center px-6 bg-[var(--bg-primary)]">
         <div className="max-w-xl w-full bg-white dark:bg-slate-800 border-b-8 border-r-4 border-l-4 border-t-4 border-slate-900 rounded-[2.5rem] p-8 md:p-12 text-center relative overflow-hidden">
             ...
             <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'repeating-linear-gradient(45deg, #000 0, #000 1px, transparent 0, transparent 20px)' }}></div>
             ...
             <div className="relative z-10">
                 ...
                 <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">Locked!</h1>
                 <p className="text-lg text-slate-500 font-bold mb-8 leading-snug">
                    This zone is for the <span className="text-[var(--brand)]">Miao Army</span> only.<br/>
  ...
  const handleGenerateMemeBase = async () => {
    ...
    try {
        if (window.puter && window.puter.ai) {
             const basePrompt = "comic style vector art, cute green cat mascot named Miao, white background, expressive, high quality";
       ...
       <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
              <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl md:text-4xl font-black text-slate-800 dark:text-white tracking-tight leading-none">Miao Tools</h1>
                          ...
                          <div className="bg-yellow-400 rounded-3xl p-8 relative overflow-hidden border-b-8 border-yellow-600">
                              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                                  <div className="text-center md:text-left">
                                      ...
                                      <p className="text-yellow-800 font-bold text-lg">Complete 3 daily quests to earn a streak bonus!</p>
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                              <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm">
                                  <h3 className="font-black text-xl text-slate-700 dark:text-slate-200 mb-6 flex items-center gap-3">
                                      <div className="w-8 h-8 rounded-lg bg-green-100 text-green-500 flex items-center justify-center"><Zap size={20} fill="currentColor"/></div>
                                      Recent Activity
                                  </h3>
                              ...
                              <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm flex flex-col justify-center text-center">
                                  ...
                                  <p className="text-sm text-slate-500 font-bold mb-6">Earn 10% of gems from every recruit you bring to the army.</p>
                      ...
                      <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-[2.5rem] p-6 md:p-8 animate-fade-up">
                          ...
                          <div className="grid md:grid-cols-2 gap-10">
                              <div className="space-y-6">
                                  <div>
                                      <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">1. The Idea</label>
                                  ...
                                  <div>
                                      <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">2. The Captions</label>
                              ...
                              <div className="bg-slate-900 rounded-3xl aspect-square flex items-center justify-center relative overflow-hidden shadow-inner group">
                                  {generatedImage ? (
                                      <>
                                        <img src={generatedImage} alt="Meme Base" className="w-full h-full object-contain" />
                                        <div className="absolute top-6 left-0 w-full text-center pointer-events-none px-4">
                                            <span className="text-white font-black text-3xl md:text-4xl uppercase tracking-tighter leading-none drop-shadow-[0_4px_0_rgba(0,0,0,1)] stroke-black" style={{ WebkitTextStroke: '2px black' }}>{topText}</span>
                                        </div>
                                        <div className="absolute bottom-6 left-0 w-full text-center pointer-events-none px-4">
                                            <span className="text-white font-black text-3xl md:text-4xl uppercase tracking-tighter leading-none drop-shadow-[0_4px_0_rgba(0,0,0,1)] stroke-black" style={{ WebkitTextStroke: '2px black' }}>{bottomText}</span>
                                        </div>
                                      </>
                                  ) : (
                  ...
                  {activeTab === 'tasks' && (
                      <div className="space-y-6 animate-fade-up">
                          ...
                          <div className="grid gap-4">
                              {[
                                  { title: "Retweet Pinned Post", reward: 200, icon: <Share2 />, color: "bg-blue-500 border-blue-700" },
                                  { title: "Join Discord Server", reward: 500, icon: <Users />, color: "bg-indigo-500 border-indigo-700" },
                                  { title: "Meme Warrior: Create 1 Meme", reward: 150, icon: <Palette />, color: "bg-purple-500 border-purple-700" },
                                  { title: "Hold 1000 $MIAO", reward: 1000, icon: <Gem />, color: "bg-green-500 border-green-700" },
                              ].map((task, i) => (
                                  <div key={i} className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-3xl border-2 border-slate-200 dark:border-slate-700 shadow-sm hover:border-slate-300 transition-colors">
                                      <div className="flex items-center gap-5">
                                          <div className={`w-16 h-16 rounded-2xl ${task.color} text-white flex items-center justify-center shadow-[inset_0_-4px_0_rgba(0,0,0,0.2)]`}>
                                      ...
                                      <button 
                                        onClick={() => { setPoints(p => p + task.reward); alert(`Quest Complete! +${task.reward} Gems`)}}
