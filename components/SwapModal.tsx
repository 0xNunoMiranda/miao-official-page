...
const SwapModal: React.FC<SwapModalProps> = ({ isOpen, onClose, walletBalance, walletAddress }) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-2xl bg-(--bg-secondary) border-4 border-(--border-color) rounded-3xl p-6 shadow-[6px_6px_0_0_var(--border-color)]">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-black text-(--text-primary)">Swap</h2>
        ...
        {showSettings && (
          <div className="mb-4 p-4 bg-(--bg-tertiary) rounded-xl border-2 border-(--border-color)">
        ...
        {isSuccess ? (
          ...
          <>
            ...
            <div className="bg-(--bg-tertiary) rounded-2xl p-4 border-2 border-(--border-color) mb-2">
            ...
            <div className="bg-(--bg-tertiary) rounded-2xl p-4 border-2 border-(--border-color) mt-2 mb-4">
              <div className="flex justify-between mb-3">
            ...
            <p className="text-center text-xs text-(--text-muted) mt-4">Powered by Jupiter Aggregator</p>
          </>
        )}
      </div>
    </div>
