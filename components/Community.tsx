...
const Community: React.FC = () => {
  return (
    <section id="community" className="py-24 px-6 md:px-12 lg:px-24 bg-[var(--bg-tertiary)] border-y-4 border-[var(--border-color)]">
        ...
        <div className="bg-[var(--bg-secondary)] p-8 md:p-12 rounded-[2rem] comic-border comic-shadow-hover transition-transform duration-300 relative overflow-hidden">
             ...
             <div className="relative z-10 grid md:grid-cols-3 gap-8">
                 <div className="flex flex-col items-center">
                    <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mb-4 comic-border border-red-500">
                 ...
                 <div className="flex flex-col items-center">
                    <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4 comic-border border-blue-500">
                 ...
                 <div className="flex flex-col items-center">
                    <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mb-4 comic-border border-yellow-500">
             ...
             <div className="mt-12 bg-[var(--bg-primary)] p-6 rounded-xl border-2 border-dashed border-[var(--border-color)]">
                 <p className="text-lg font-bold text-[var(--text-primary)]">
                    "This token belongs to everyone. There is no team allocation. 
                    Just a green cat and the internet. Good luck."
                 </p>
